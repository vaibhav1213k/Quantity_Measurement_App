...
public class  LengthTest {
    ...
    void testLengthUnitenum_CentimetersConstant() {
        assertNotNull(LengthUnit.CM);
        assertEquals(2.54, LengthUnit.CM.toBaseUnit(1.0), EPSILON);
        assertEquals(1.0, LengthUnit.CM.fromBaseUnit(2.54), EPSILON);
    }
...
void testAddition_ExplicitTargetUnit_Feet() {
    ...
    void testBackwardCompatibility_UC7AdditionWithtargetUnitTests() {
        ...
        Length inFeet = Length.Addition(l1, l2, LengthUnit.FEET);
        Length inInches = Length.Addition(l1, l2, LengthUnit.Inches);
        Length inYards = Length.Addition(l1, l2, LengthUnit.YARD);
        Length inCm = Length.Addition(l1, l2, LengthUnit.CM);

        assertEquals(2.0, inFeet.value, EPSILON);
        assertEquals(24.0, inInches.value, EPSILON);
        assertEquals(0.667, inYards.value, EPSILON);
        assertEquals(60.96, inCm.value, EPSILON);
    }
}
